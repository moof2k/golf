...
struct S3DSMesh {
	...
	PVRTVECTOR3	fCentre;			/*!< Mesh centre */
	PVRTVECTOR3	fMinimum;		/*!< Bounding box's lower front corner */
	PVRTVECTOR3	fMaximum;		/*!< Bounding box's upper back corner */
...
*****************************************************************************/
struct S3DSLight {
		PVRTVECTOR3	fPosition;		/*!< Light position in World coordinates */
...
struct S3DSCamera {
		...
		PVRTVECTOR3	fPosition;		/*!< Camera position */
		PVRTVECTOR3	fTarget;			/*!< Camera looking point */
...
struct S3DSNode {
	...
	PVRTVECTOR3	Pivot;		/*!< Pivot for this mesh */
...
struct S3DSScene {
	...
	PVRTVECTOR3		fGroupCentre;	/*!< Centre of object */
	PVRTVECTOR3		fGroupMinimum;	/*!< Bounding box's lower front corner */
	PVRTVECTOR3		fGroupMaximum;	/*!< Bounding box's upper back corner */
...
class CPVRT3DSScene : public S3DSScene
{
	public:
	/*!***************************************************************************
	...
	*****************************************************************************/
	void GetTransformationMatrix(PVRTMATRIX	&mOut, const S3DSMesh &node);
	/*!***************************************************************************
	@Function			GetCamera
	...
	@Description		Return position and target required to animate this camera at the
						current frame.
	*****************************************************************************/
	bool GetCamera(PVRTVECTOR3	&vFrom,PVRTVECTOR3 &vTo, const unsigned int nIdx) const;

protected:
	PVRTMATRIX GetHierarchyMatrix(short Node, VERTTYPE fFrameNumber, PVRTMATRIX CurrentMatrix);
	void GetAbsoluteRotation(PVRTMATRIX * const pmRot, VERTTYPE fFrameNumber, S3DSNode *pNode);
	PVRTVECTOR3f Normal(VERTTYPE *pV1, VERTTYPE *pV2, VERTTYPE *pV3);
