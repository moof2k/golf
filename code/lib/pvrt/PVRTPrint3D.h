...
public:
	...
	*****************************************************************************/
	bool Print3D(float fPosX, float fPosY, const float fScale, unsigned int Colour, const char * const pszFormat, ...);
	...
	/*!***************************************************************************
	 ...
	 @Description		Creates a default title with predefined position and colours.
						...
						2 = Img Tech logo
	*****************************************************************************/
	 bool DisplayDefaultTitle(const char * const pszTitle, const char * const pszDescription, const unsigned int uDisplayLogo);
	...
	*****************************************************************************/
	bool DisplayWindow(unsigned int dwWin);
	...
	/*!***************************************************************************
	 ...
	 @Description		Feed the text buffer of window referenced by dwWin.
						This function accepts formatting in the printf way.
	*****************************************************************************/
	bool SetText(unsigned int dwWin, const char *Format, ...);
