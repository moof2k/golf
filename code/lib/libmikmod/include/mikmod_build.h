...
#if !defined(OBJC_EXPORT)&&!defined(objc_EXPORT)
...
enum {
	...
	MMERR_IPHONE_UNUSED,
	MMERR_IPHONE_CREATEQUEUE,
	MMERR_IPHONE_ALLOCBUFFER,
	MMERR_IPHONE_VOLUME,
	MMERR_IPHONE_PLAYBACK,
	MMERR_IPHONE_ENQUEUEBUFFER,
...
MIKMODAPI extern struct MDRIVER drv_iphone; /* iPhone/iPodTouch AudioQueue driver */
